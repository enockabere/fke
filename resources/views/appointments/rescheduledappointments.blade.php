        ...
        <ol class="breadcrumb d-flex justify-content-end breadcrumb-box">
            ...
            <li class="breadcrumb-item dropdown" id="breadcrumbDropdown">
                <a href="#" class="breadcrumbs text-muted dropdown-toggle" role="button" aria-haspopup="true"
                    aria-expanded="false">
                    <i class="fas fa-sync-alt"></i> Rescheduled Appointments
                </a>
    ...
    <div class="col-sm-12 col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <p>
                <h4 style="text-align: center"> Proposed Date & Time</h4>
                </p>
                ...
                <div class="row AllAppointments">
                    ...
                    <div class="col-12">
                        ...
                        <p class="adate"><i class="fas fa-calendar-alt"></i>{{$item['Suggested_Date']}}</p>
                        <p class="atime"><i class="far fa-clock"></i>{{$item['Suggested_Time']}}</p>
                        <p class="atime"><i class="far fa-clock"></i>{{$item['Status']}}</p>
    ...
    $('.AllAppointments').on('click', '#View_details', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (MyDetails !== null) {
                    $('#Apptitle').append('Proposed Date & Time');
